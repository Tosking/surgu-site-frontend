          ...
          <div className="flex flex-col text-black text-[18px] font-[400] gap-[64px] px-[16px]">
            <div className="flex flex-col gap-[24px] text-justify">
              <span>
                ...
                <br />
                <span className="font-[700]">&middot;</span> Mastercard
                Worldwide
                <br />
              ...
              <span>
                ...
                перенаправлены на платежный шлюз ООО «СПЕЦИАЛЬНЫЕ ПЛАТЕЖНЫЕ
                РЕШЕНИЯ». Соединение с платежным шлюзом и передача информации
                осуществляется в защищенном режиме с использованием протокола
                шифрования SSL. В случае если Ваш банк поддерживает технологию
                безопасного проведения интернет-платежей Verified By Visa,
                MasterCard SecureCode, MIR Accept, J-Secure, для проведения
                платежа также может потребоваться ввод специального пароля.
              </span>
              <span>
                ...
                соответствии с требованиями платежных систем МИР, Visa Int.,
